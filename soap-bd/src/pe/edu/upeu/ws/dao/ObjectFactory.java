 ...
 * generated in the pe.edu.upeu.ws.dao package. 
...
public class ObjectFactory {
    ...
    private final static QName _ReadVenta_QNAME = new QName("http://dao.ws.upeu.edu.pe/", "readVenta");
    private final static QName _ReadVentaResponse_QNAME = new QName("http://dao.ws.upeu.edu.pe/", "readVentaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: pe.edu.upeu.ws.dao
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao.ws.upeu.edu.pe/", name = "readVenta")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://dao.ws.upeu.edu.pe/", name = "readVentaResponse")
